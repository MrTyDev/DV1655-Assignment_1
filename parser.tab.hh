  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LBRACE = 16,                           // LBRACE
        S_RBRACE = 17,                           // RBRACE
        S_LBRACKET = 18,                         // LBRACKET
        S_RBRACKET = 19,                         // RBRACKET
        ...
        S_STRING = 27,                           // STRING
        S_RETURN = 28,                           // RETURN
        S_INT_TYPE = 29,                         // INT_TYPE
        S_BOOLEAN = 30,                          // BOOLEAN
        S_IF = 31,                               // IF
        S_ELSE = 32,                             // ELSE
        S_WHILE = 33,                            // WHILE
        S_PRINTLN = 34,                          // PRINTLN
        S_LENGTH = 35,                           // LENGTH
        S_TRUE = 36,                             // TRUE
        S_FALSE = 37,                            // FALSE
        S_THIS = 38,                             // THIS
        S_NEW = 39,                              // NEW
        S_EXTENDS = 40,                          // EXTENDS
        ...
        S_class_declaration_list = 50,           // class_declaration_list
        S_class_declaration = 51,                // class_declaration
        S_type = 52,                             // type
        S_var_declaration_list = 53,             // var_declaration_list
        S_var_declaration = 54,                  // var_declaration
